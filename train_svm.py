...
if __name__ == '__main__':
    ...
    if USE == 'map':
        y = []
        # y: labels
        label_file = open('/home/ubuntu/11775-hws-MED3/all_trn.lst', 'r')
        for i in label_file:
        ...
        y = []
        # y: labels
        label_file_train = open('/home/ubuntu/11775-hws-MED3/all_trn.lst', 'r')
        for i in label_file_train:
            ...
            if label == event_name:
                ...
                y.append(0)
        lable_file_val = open('/home/ubuntu/11775-hws-MED3/all_val.lst', 'r')
        ...
        for i in feature_file:
            ...
            try:
                ...
                continue
    # linear, poly, rbf, sigmoid, cosine_similarity, laplacian_kernel, chi2_kernel
    model = SVC(kernel=laplacian_kernel, gamma='scale', class_weight='balanced')
    # print(x)
    # print(y)
    model.fit(x, y)
